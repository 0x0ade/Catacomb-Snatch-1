 ...
 * used by Shadow Engine. It currently is used as hack as long
 * as there is no official OpenAL generator.
 * <br>
 * This class is a copy from the Shadow Engine equivalent for
 * usage outside of Shadow Engine.
 */
public class ShadowJglfwApplication extends JglfwApplication {
	...
	/**
	 * Starts the game loop and initializes OpenAL and other hack dependant
	 * stuff as overriding initialization was impossible.
	 */
	@Override
