...
import net.catacombsnatch.game.core.core.world.level.generator.options.GeneratorOption;
...
public abstract class LevelGenerator {
	...
	/**
	 * Generates a new Level for the given {@link net.catacombsnatch.game.core.core.world.Campaign}
	 * 
