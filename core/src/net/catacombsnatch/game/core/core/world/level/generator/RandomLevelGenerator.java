package net.catacombsnatch.game.core.core.world.level.generator;
...
import net.catacombsnatch.game.core.core.world.level.generator.RandomLevelGenerator.Cell.Type;
...
import net.catacombsnatch.game.core.core.world.tile.tiles.WallTile;
