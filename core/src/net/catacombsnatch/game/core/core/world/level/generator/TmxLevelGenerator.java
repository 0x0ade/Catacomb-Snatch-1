...
import net.catacombsnatch.game.core.core.world.level.generator.options.GeneratorStringOption;
import net.catacombsnatch.game.core.core.world.tile.TileRegistry;
import net.catacombsnatch.game.core.core.world.tile.tiles.HoleTile;
