package net.catacombsnatch.game.core.core.entity;

import net.catacombsnatch.game.core.core.entity.components.Health;
import net.catacombsnatch.game.core.core.entity.components.Position;
import net.catacombsnatch.game.core.core.entity.components.Render;
...
import net.catacombsnatch.game.core.core.entity.renderers.PlayerRenderer;
import net.catacombsnatch.game.core.core.entity.renderers.TileRenderer;
