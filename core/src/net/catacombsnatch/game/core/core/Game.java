package net.catacombsnatch.game.core.core;
...
import net.catacombsnatch.game.core.core.sound.ISoundPlayer;
import net.catacombsnatch.game.core.core.event.EventHandler;
import net.catacombsnatch.game.core.core.event.EventManager;
import net.catacombsnatch.game.core.core.event.input.InputManager;
import net.catacombsnatch.game.core.core.event.input.Key;
import net.catacombsnatch.game.core.core.event.input.events.KeyPressedEvent;
import net.catacombsnatch.game.core.core.player.LocalPlayer;
...
import net.catacombsnatch.game.core.core.resource.options.Options;
import net.catacombsnatch.game.core.core.resource.options.PreferenceOptions;
import net.catacombsnatch.game.core.core.scene.SceneManager;
import net.catacombsnatch.game.core.core.scene.scenes.TitleScreen;
import net.catacombsnatch.game.core.core.sound.GdxSoundPlayer;
import net.catacombsnatch.game.core.core.sound.NoSoundPlayer;
...
public class Game implements ApplicationListener {
    ...
    protected DateFormat dateFormatScreenshot = new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss");
	...
	public void keyPressed(KeyPressedEvent event) {
        ...
        String filename = "screen_"+(dateFormatScreenshot.format(Calendar.getInstance().getTime()))+".png";
		
		switch (Gdx.app.getType()) {
			case Desktop:
				Screen.saveScreenshot(Gdx.files.local(filename));
				break;
